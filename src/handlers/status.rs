...
use crate::{
    ...
    models::status::{HistoryEntry, get_history, get_metrics_with_fallback},
};
...
fn get_health_display(score: u8) -> (String, String, String) {
    match score {
        ...
        60..=74 => (
            ...
            "État Moyen".to_string(),
        ),
        40..=59 => (
            "error".to_string(),
            "alert-circle".to_string(),
            "État Dégradé".to_string(),
        ),
        _ => (
            "error".to_string(),
            "x-circle".to_string(),
            "État Critique".to_string(),
        ),
    }
}
...
fn get_status_info_from_metrics(
    metrics: &crate::models::status::PerformanceMetrics,
) -> (String, String) {
